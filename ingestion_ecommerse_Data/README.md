# ingestion_ecommerse_Data

This folder defines all source code for the 'ingestion_ecommerse_Data' pipeline:
...
* Take a look at the sample under "sample_users_ingestion_ecommerse_data.py" to get familiar with the syntax.
